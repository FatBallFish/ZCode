...
const enUS: Record<string, string> = {
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to Mikiko bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "Mikiko saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "Mikiko uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to Mikiko.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to Mikiko's `/api/bots/webhook` endpoint.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another Mikiko window.",
  ...
  "webRemoteControl.trigger": "Bot remote control",
  "webRemoteControl.title": "Bot remote control",
  "webRemoteControl.description": "Control Mikiko workspaces through chat bots.",
  ...
  "remoteControl.device.unknown": "Mobile device",
  "remoteControl.connected.disconnect": "Disconnect",
  "remoteControl.connected.stop": "Turn off remote control",
  "remoteControl.waiting.title": "Reconnecting…",
  "remoteControl.waiting.hint": "Waiting for the device to reconnect.",
  "remoteControl.qr.hint": "Can't scan? Open the link on your phone.",
  "remoteControl.expiry.longTerm": "No expiry",
  "remoteControl.expiry.expiresIn": "Expires in {time}",
  "remoteControl.pending.refresh": "Refresh QR code",
  "remoteControl.pending.autoRefresh": "Auto refresh",
  "remoteControl.pending.copyLink": "Copy link",
  "remoteControl.pending.copied": "Copied",
  "settings.dataBaseDirBrowseUnsupported": "System directory picker is unavailable here",
