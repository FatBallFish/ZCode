...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 Mikiko 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 Mikiko 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Mikiko 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Mikiko",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Mikiko。",
  ...
  "startup.global.starting_services": "正在启动 Mikiko",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Mikiko。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Mikiko 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 Mikiko",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 Mikiko 后重试",
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 Mikiko 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "Mikiko 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "Mikiko 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 Mikiko 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 Mikiko 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 Mikiko 窗口处理。",
  ...
  "login.title": "欢迎来到 Mikiko",
  "login.description": "连接账号，开始使用 Mikiko",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 Mikiko？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Mikiko Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 Mikiko",
  ...
  "titleBar.menu.help.toggleMikikoStdioTap": "抓取 Agent stdio 通信",
  ...
  "forceUpdate.title": "需要升级 Mikiko 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Mikiko 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Mikiko CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "webRemoteControl.trigger": "Bot 远程控制",
  "webRemoteControl.title": "Bot 远程控制",
  "webRemoteControl.description": "通过聊天机器人控制 Mikiko 工作区。",
  ...
  "remoteControl.device.unknown": "移动设备",
  "remoteControl.connected.disconnect": "断开连接",
  "remoteControl.connected.stop": "关闭远程控制",
  "remoteControl.waiting.title": "设备重连中…",
  "remoteControl.waiting.hint": "等待设备重新连接。",
  "remoteControl.qr.hint": "无法扫码？可以在手机上打开链接。",
  "remoteControl.expiry.longTerm": "长期有效",
  "remoteControl.expiry.expiresIn": "{time} 后失效",
  "remoteControl.pending.refresh": "刷新二维码",
  "remoteControl.pending.autoRefresh": "自动刷新",
  "remoteControl.pending.copyLink": "复制链接",
  "remoteControl.pending.copied": "已复制",
  "settings.dataBaseDirBrowseUnsupported": "当前环境不支持系统目录选择器",
  ...
  "settings.themeMode.mikiko-light": "浅色",
  "settings.themeMode.mikiko-dark": "深色",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Mikiko 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 Mikiko 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .mikiko/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Mikiko 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "sidebar.settings.theme.mikiko-light": "浅色主题",
  "sidebar.settings.theme.mikiko-dark": "深色主题",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 Mikiko 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "Mikiko 总占用",
  ...
  "resourceManager.storage.diskUsage": "Mikiko 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Mikiko 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Mikiko 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Mikiko。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Mikiko 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.sub2api.sites.title": "站点",
  "settings.sub2api.site.add": "添加站点",
  "settings.sub2api.site.added": "站点已添加",
  "settings.sub2api.site.urlPlaceholder": "Sub2api 站点地址（如 https://example.com）",
  "settings.sub2api.account.email": "邮箱",
  "settings.sub2api.account.loading": "正在加载账户信息…",
  "settings.sub2api.subscriptions.title": "订阅",
  "settings.sub2api.subscriptions.expires": "到期",
  "settings.sub2api.keys.create": "创建密钥",
  "settings.sub2api.keys.created": "已创建 {name}",
  "settings.sub2api.keys.updated": "密钥已更新",
  "settings.sub2api.keys.noGroup": "未分组",
  "settings.sub2api.keys.disable": "停用",
  "settings.sub2api.keys.enable": "启用",
  "settings.sub2api.models.title": "模型",
  "settings.sub2api.models.hint":
    "模型清单来自当前密钥所属分组的网关接口；激活后即可在「{provider}」供应商下选择会话模型。模型配置按 站点-密钥-模型 维度保存在本地。",
  "settings.sub2api.login.captchaFailed": "人机验证未通过，请完成验证后重试",
  "settings.sub2api.login.invalidCredential": "邮箱或密码错误",
  "settings.sub2api.login.totpPlaceholder": "6 位动态验证码",
  "settings.sub2api.unavailable": "中转站服务当前不可用",
  "settings.sub2api.models.custom": "自定义",
  "settings.sub2api.models.emptyActive": "当前密钥未返回可用模型，请先激活密钥或检查分组白名单。",
  "settings.sub2api.models.addPlaceholder": "手动添加模型 ID（如 gpt-4o）",
  "settings.sub2api.models.add": "添加模型",
  "settings.sub2api.window.daily": "每日剩余",
  "settings.sub2api.window.weekly": "每周剩余",
  "settings.sub2api.window.monthly": "每月剩余",
  "settings.sub2api.site.toggle": "站点启停",
  "settings.sub2api.keys.rename": "重命名",
  "settings.sub2api.site.delete": "删除站点",
  "settings.sub2api.site.deleteConfirmTitle": "删除站点「{name}」",
  "settings.sub2api.site.deleteConfirmDesc":
    "将删除该站点及其全部 API 密钥对应的模型供应商，且不可恢复。",
  "settings.sub2api.site.deleteConfirmAction": "删除",
  "settings.sub2api.site.removed": "站点已删除",
  "settings.sub2api.site.newSite": "新站点",
  "settings.sub2api.title.mikikocc": "Mikiko CC",
  "settings.sub2api.description.mikikocc": "登录MikikoCC，自动同步密钥模型",
  "settings.sub2api.title.sub2api": "Sub2api 网关",
  "settings.sub2api.description.sub2api":
    "通过 Sub2API 站点管理 API Key。激活的 Key 会作为“Sub2api 网关”供应商出现在模型选择器中，切换后新会话立即使用新 Key 请求。",
  "settings.sub2api.site.address": "站点地址",
  "settings.sub2api.keys.manageModels": "配置模型",
  "settings.sub2api.keys.sync": "同步到模型列表",
  "settings.sub2api.keys.groupSelect": "切换分组",
  "settings.sub2api.keys.toggleStatus": "启用/停用密钥",
  "settings.sub2api.keys.syncFirst": "尚未同步该密钥的供应商，点击上方「同步到模型列表」。",
  "settings.sub2api.usage.notLoggedIn": "中转站未登录，请先在「设置 → Mikiko 网关」完成登录。",
  "settings.sub2api.usage.planTitle": "套餐与余额",
  "settings.sub2api.usage.remaining": "剩余",
  "settings.sub2api.usage.resetAt": "重置",
  "settings.sub2api.usage.noSubscriptions": "暂无订阅",
  "settings.sub2api.usage.totalRequests": "请求总数",
  "settings.sub2api.usage.totalTokens": "Tokens 总量",
  "settings.sub2api.usage.totalCost": "花费",
  "settings.sub2api.usage.heatmap": "Token 活动热力图",
  "settings.sub2api.usage.modelTrend": "模型时间线",
  "settings.sub2api.usage.modelSummary": "模型用量汇总",
  "settings.sub2api.usage.modelShare": "模型用量占比",
  "settings.sub2api.usage.empty": "所选时间范围内暂无用量",
  "settings.usage.tab.sub2api": "中转站用量",
  "settings.usage.tab.sub2apiPlan": "中转站套餐",
  "settings.modelProvider.relayMikikoccDesc": "自有 Sub2API 站点，内置地址，登录即用",
  "settings.modelProvider.relaySub2apiDesc": "连接自建 Sub2API 站点（填写 BaseURL）",
  "login.sub2api.mikikocc": "通过 MikikoCC 登录",
  "login.sub2api.sub2api": "通过 Sub2api 登录",
  "login.sub2api.mikikocc.hint": "使用 MikikoCC 账号登录，即可管理 API 密钥、查看余额与订阅。",
  "login.sub2api.sub2api.hint": "输入 Sub2API 站点地址，验证通过后登录。",
  "settings.modelProvider.relayTitle": "中转站",
  "settings.modelProvider.templateGroup.relay": "中转站",
  "settings.sub2api.title": "Mikiko 网关",
  "settings.sub2api.description":
    "通过 Sub2API 站点管理 API Key。激活的 Key 会作为“Mikiko 网关”供应商出现在模型选择器中，切换后新会话立即使用新 Key 请求。",
  "settings.sub2api.account.title": "站点账号",
  "settings.sub2api.account.balance": "余额",
  "settings.sub2api.account.refresh": "刷新",
  "settings.sub2api.account.logout": "退出登录",
  "settings.sub2api.login.email": "邮箱",
  "settings.sub2api.login.password": "密码",
  "settings.sub2api.login.submit": "登录",
  "settings.sub2api.login.hint": "站点开启人机验证时无法密码登录，请直接粘贴 API Key。",
  "settings.sub2api.login.success": "登录成功，已同步 {count} 个密钥",
  "settings.sub2api.login.failed": "登录失败",
  ...
  "settings.sub2api.keys.activated": "已切换为当前密钥",
  "settings.sub2api.keys.active": "使用中",
  "settings.sub2api.keys.activate": "启用",
  "settings.sub2api.keys.delete": "删除",
  "settings.sub2api.keys.empty": "暂无密钥。粘贴一个 sk- 开头的 API Key 开始使用。",
  "settings.sub2api.usage.refresh": "刷新当前密钥状态",
  "settings.modelProviderTitle": "模型设置",
  "settings.mcpTitle": "MCP 服务器",
  "settings.mcp.description": "管理 Mikiko Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Mikiko 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Mikiko Agent 不支持 OAuth 状态刷新。请升级或重启 Mikiko，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 Mikiko。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Mikiko",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 Mikiko 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 Mikiko 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 Mikiko 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Mikiko 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Mikiko 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Mikiko 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "Mikiko 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Mikiko。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Mikiko 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Mikiko",
  ...
  "settings.subagents.description": "管理 Mikiko Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Mikiko 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Mikiko，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Mikiko 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Mikiko",
  ...
  "settings.commands.description":
    "管理 Mikiko Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Mikiko。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Mikiko 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Mikiko",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Mikiko 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Mikiko",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 Mikiko",
  "onboarding.welcome.start": "开始使用 Mikiko",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Mikiko 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Mikiko 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Mikiko 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Mikiko 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Mikiko 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Mikiko 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 Mikiko 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "Mikiko MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Mikiko MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Mikiko 报错信息",
  ...
  "offPeak.keepAwakeBanner": "Mikiko 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Mikiko 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Mikiko 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Mikiko 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Mikiko",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Mikiko 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Mikiko 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Mikiko 会针对该会话精确验证电脑控制工具。",
