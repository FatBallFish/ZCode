...
const messages = {
  "zh-CN": {
    ...
    remoteReconnectUnavailable:
      "当前远端项目 {workspacePath} 未连接，但机器人无法访问远端重连服务。请先在 Mikiko 打开该远端项目后重试。",
  ...
  "en-US": {
    ...
    remoteReconnectUnavailable:
      "The remote workspace {workspacePath} is not connected, but the bot cannot access the remote reconnect service. Open this remote project in Mikiko and try again.",
